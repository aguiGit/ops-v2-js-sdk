...
var fromAddress = "tOPSeBaMu38g1vnJsSZUCwTDU9GsE5TVNUtpD";
//黑洞地址
var toAddress = 'tOPSeBaMhZnRteniCy3UZqPjTbnWKBPHX1a5d';
...
async function setAlias(pri, pub, fromAddress, toAddress, assetsChainId, assetsId, amount, remark) {
  ...
  //交易组装
  var tAssemble = await ops.transactionAssemble(inOrOutputs.data.inputs, inOrOutputs.data.outputs, remark, 3, aliasInfo);
