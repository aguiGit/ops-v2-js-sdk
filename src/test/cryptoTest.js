...
describe("crypto", function () {
  ...
  it("whole encrypt success", async function () {
    let data = "Information:Modules \"ops-base\", \"ops-core-rockdb\", \"ops-core-rpc\", \"ops-base-api-provider\", \"ops-base-protocol-update\" and 我们认为NFT的使用案例由个人拥有和交易，以及托运给第三方经纪人/钱包/拍卖商（“运营商”）。NFT可以代表对数字或实物资rebuilt due to project configuration/dependencies changes";
