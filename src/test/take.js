...
const {getOpsBalance, inputsOrOutputs, validateTx, broadcastTx} = require('./api/util');
...
let fromAddress = "tOPSeBaMfwpGBmn8xuKABPWUbdtsM2cMoinnn";
...
async function take(pri, pub, fromAddress, assetsChainId, assetsId, amount, depositHash) {
  ...
  let tAssemble =  await ops.transactionAssemble(inOrOutputs.inputs, inOrOutputs.outputs, remark, 6, depositHash);
