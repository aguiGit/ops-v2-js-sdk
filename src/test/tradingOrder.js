...
let address = "tOPSeBaMu38g1vnJsSZUCwTDU9GsE5TVNUtpD";
...
async function tradingOrder(tradingOrderInfo) {
  ...
  //交易组装
  let tAssemble = await ops.transactionAssemble(inOrOutputs.data.inputs, inOrOutputs.data.outputs, remark, txType, tradingOrderInfo);
