...
//创建交易对收款地址
let toAddress = 'tOPSeBaMqywZjfSrKNQKBfuQtVxAHBQ8rB2Zn';
//创建交易对需要金额
...
async function coinTrading(transferInfo, coinTradingInfo) {
    ...
    //交易组装
    let tAssemble = await ops.transactionAssemble(inOrOutputs.data.inputs, inOrOutputs.data.outputs, remark, txType, coinTradingInfo);
